...
/*   Updated: 2025/03/21 13:32:03 by macastro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_game_on_img(t_game *game)
{
	...
	while (i < WIN_W)
	{
		...
		assign_point_floats(wall_pts[0], WIN_W - i - 1, floor(wall_pts[0][Y]));
		assign_point_floats(wall_pts[1], WIN_W - i - 1, floor(wall_pts[1][Y]));
